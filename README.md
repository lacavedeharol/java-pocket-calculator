...
Functional desktop calculator application built with Java and Swing, featuring a graphical user interface, performs basic arithmetic operations.
...
```bash
java -jar target/java-pocket-calculator-1.0.0-SNAPSHOT.jar
```
